...
**KaMenu** 是一款面向 Minecraft 服务器的菜单插件。公共运行时以 Bukkit/Spigot 1.16.5 API 为兼容基线；Paper/Folia 使用 Paper Dialog API，Spigot 1.21.6+ 使用 Bungee Dialog API。较低版本会自动禁用原生 Dialog，但仍可使用容器类菜单、actions、变量、JavaScript、存储和自定义指令。
